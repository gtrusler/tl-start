...
import { 
  ...
  Flower2, AlertTriangle, TrendingUp, TrendingDown, Phone, Upload, 
  Copy, Check, X
} from "lucide-react"
...
export default function Dashboard() {
  ...
  const handleFileUpload = async (file: File) => {
    ...
    try {
      ...
      setUploadResult(result.url || 'No URL returned')
    } catch (error) {
          ...
          <div className="p-6 pt-0">
            ...
            <div className="bg-card rounded-2xl p-6 shadow-lg animate-in slide-in-from-bottom duration-1100">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                ...
                {/* Temp File Link Card */}
                <div className="bg-muted hover:bg-primary/10 p-4 rounded-xl text-center transition-all hover:-translate-y-1 hover:shadow-md group">
                  <Upload className="w-12 h-12 text-primary mx-auto mb-2 group-hover:scale-110 transition-transform" />
                  <span className="text-sm font-medium text-foreground group-hover:text-primary block mb-2">Temp File Link</span>
                  <span className="text-xs text-muted-foreground block mb-4">Upload files and get temporary sharing links</span>
                  ...
                  >
                    {uploadLoading ? (
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-green-600 font-medium">Upload successful!</div>
                        <div className="flex items-center gap-1 bg-background rounded p-2">
                          <input
                            type="text"
                            value={uploadResult}
                            readOnly
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-muted-foreground">
                          ...
                          <label className="text-primary hover:text-primary/80 cursor-pointer transition-colors">
                            browse
                            <input
                              type="file"
