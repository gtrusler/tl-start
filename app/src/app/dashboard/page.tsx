...
export default function Dashboard() {
  ...
  const resourceLinks = [
    ...
    { icon: Zap, label: "Passphrase Generator", url: "https://claude.ai/public/artifacts/015362e2-dfa9-48db-a61f-3f57c4ea14a7", description: "Generate secure, memorable passphrases for your accounts" },
  ]
